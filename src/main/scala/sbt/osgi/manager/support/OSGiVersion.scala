...
// based on https://github.com/inventage/version-tiger/blob/master/com.inventage.tools.versiontiger/src/main/java/com/inventage/tools/versiontiger/internal/impl/OsgiVersionImpl.java
/*sbt.osgi.manager
